            ...
            {user ? (
              <>
                ...
                <div className="relative group ml-4">
                  <button className="flex items-center hover:text-neutral transition-colors focus:outline-none bg-primary/10 px-3 py-1 rounded-md border border-primary/20">
                  ...
                  <div className="absolute right-0 mt-2 w-56 bg-white rounded-md shadow-lg py-1 z-10 hidden group-hover:block border border-border">
                    ...
                    <Link to={user.role === 'admin' ? '/admin/settings' : '/settings'} className="block w-full text-left px-4 py-2 text-sm text-dark hover:bg-primary/5 transition-colors">
                      Settings
                    </Link>
                    <button
                      onClick={logout}
