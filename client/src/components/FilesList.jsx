          ...
          <li key={index} className="flex flex-col p-3 border border-secondary/20 rounded-md bg-white hover:bg-secondary/5 transition-colors">
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <a
                  href={file.path.startsWith('http') ? file.path : `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL || 'http://localhost:5000'}${file.path}`}
                  target="_blank"
                  ...
                  onClick={(e) => {
                    ...
                    if (!file.path.startsWith('http')) {
                      ...
                      const baseUrl = `${import.meta.env.VITE_REACT_APP_BACKEND_BASEURL || 'http://localhost:5000'}${file.path}`;
