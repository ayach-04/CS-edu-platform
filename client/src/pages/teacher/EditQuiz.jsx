...
const EditQuiz = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Update the quiz
      await teacherAPI.updateQuiz(quizId, quizData);
  ...
  const handlePublish = async () => {
    ...
    try {
      // Update the quiz and set isPublished to true
      await teacherAPI.updateQuiz(quizId, { ...quizData, isPublished: true });
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-6">
          ...
          {quizData.questions.map((question, questionIndex) => (
            <div key={questionIndex} className="card border border-gray-200 rounded-lg p-6 bg-white shadow-sm">
        ...
        <div className="flex justify-end space-x-4">
          ...
          >
            {quiz?.isPublished ? 'Update & Keep Published' : 'Publish Quiz'}
          </button>
