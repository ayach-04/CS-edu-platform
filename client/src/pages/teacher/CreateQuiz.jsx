...
const CreateQuiz = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Create the quiz
      const response = await teacherAPI.createQuiz(moduleId, quizData);

      setSuccessMessage('Quiz created successfully!');

      // Redirect to manage modules page after a short delay
      setTimeout(() => {
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        <div className="space-y-6">
          ...
          {quizData.questions.map((question, questionIndex) => (
            <div key={questionIndex} className="card border-2 border-gray-200">
