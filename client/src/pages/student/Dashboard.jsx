    ...
    <div className="space-y-8">
      ...
      <div className="bg-white p-6 rounded-lg shadow-md border border-gray-100">
        ...
        <p className="text-gray-600 mb-6">
          From here you can access your enrolled modules and discover new courses. Your academic year is set to <span className="font-medium text-[#e14177]">{user.academicYear}</span>.
        </p>
        <div>
      ...
      {availableModules.length > 0 && (
        <div>
          <h2 className="text-2xl font-bold mb-4 text-[#004080]">Available Modules</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
      ...
      <div className="bg-white p-6 rounded-lg shadow-sm hover:shadow-md transition-all duration-300 border border-gray-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <Link to="/student/modules" className="flex flex-col items-center justify-center p-4 bg-secondary/5 rounded-lg hover:bg-secondary/10 transition-colors text-center">
            ...
            <h4 className="font-medium mb-1">Browse Modules</h4>
