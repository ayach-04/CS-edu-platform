...
const TakeQuiz = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // After a short delay, navigate back to the quizzes page with a refresh flag
      setTimeout(() => {
        navigate(`/student/modules/${quiz.module._id}/quizzes`, {
          state: { refreshQuizzes: true, timestamp: Date.now() }
        });
      }, 3000);
    } catch (err) {
