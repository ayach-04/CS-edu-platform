  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="card hover:shadow-md transition-all duration-300">
          <h3 className="text-xl font-bold mb-6 pb-2 border-b border-border">Quick Actions</h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Link to="/admin/users" className="flex flex-col items-center justify-center p-4 bg-primary/5 rounded-lg hover:bg-primary/10 transition-colors text-center">
            ...
            <Link to="/admin/modules" className="flex flex-col items-center justify-center p-4 bg-secondary/5 rounded-lg hover:bg-secondary/10 transition-colors text-center">
            ...
            <Link to="/admin/modules/create" className="flex flex-col items-center justify-center p-4 bg-accent/5 rounded-lg hover:bg-accent/10 transition-colors text-center">
            ...
            <Link to="/admin/users" className="flex flex-col items-center justify-center p-4 bg-accent/5 rounded-lg hover:bg-accent/10 transition-colors text-center">
              <div className="bg-accent/10 p-3 rounded-full mb-3">
                <svg className="w-6 h-6 text-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" />
                </svg>
              </div>
              <span className="font-medium">Approve Users</span>
            </Link>
          </div>
        </div>
      </div>
